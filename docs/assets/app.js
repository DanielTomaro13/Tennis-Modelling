...
function marketGrid(m, n1, n2, winA) {
  ...
  const cards = [
    ...
    m.exp_breaks_a !== undefined ? mktCard("Breaks of serve", [
      [`Expected ${n1}`, m.exp_breaks_a.toFixed(1)],
      [`Expected ${n2}`, m.exp_breaks_b.toFixed(1)],
      ["Total expected", m.exp_total_breaks.toFixed(1)],
    ]) : "",
